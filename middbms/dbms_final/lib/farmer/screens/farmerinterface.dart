  ...
  Widget build(BuildContext context){
        ...
        padding: new EdgeInsets.only(top: 30.0,left:10.0),
          ...
          [
           ...
           (
              ...
              onTap:(){Navigator.push(context,MaterialPageRoute(builder: (context)=>Viewcityagro()));},
           ),
           ListTile
           (
              leading: Logoutimage(),
    ...
    bottomNavigationBar: BottomNavigationBar(
        items: <BottomNavigationBarItem>[
          BottomNavigationBarItem(icon: Icon(Icons.people), title: Text('Customer')),
          BottomNavigationBarItem(icon: Icon(Icons.person), title: Text('Experts')),
          BottomNavigationBarItem(icon: Icon(Icons.cloud), title: Text('Weather')),
        ],
